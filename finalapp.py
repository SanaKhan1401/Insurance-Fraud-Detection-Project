...
with col3:
    ...
    if st.button("Predict Fraud"):
        if st.button("Predict Fraud"):
            ...
            si = si_mapping[si]
            oc_mapping = {'Armed Forces': 0, 'Craft RepairExec Managerial': 1, 'Farming Fishing': 2,
                  'Handlers Cleaners': 3, 'Machine Op Inspct': 4, 'Other Service': 5,
                  'Priv House Serv': 6, 'Prof Specialty': 7, 'Protective Serv': 8,
                  'Sales': 9, 'Tech Support': 10, 'Transport Moving': 11}
            oc = oc_mapping[oc]
